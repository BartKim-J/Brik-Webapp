...
Spendwallet is seductively designed to completely replace your existing wallet. The backside pocket is for your ID, cash, or anything that cannot be stored digitally on the device.`,
  ...
  'index.heading.fat': `Monitor your<br /> everyday health data.`,
  'index.heading': `Astera is a blockchain for your<br /> personal health data. Collect and<br /> control your everyday data with<br /> Astera device we provide for free.`,
  ...
  'index.charge.description': `IoMT hardware for health<br /> data blockchain.`,
  'index.menu.whitepaper':'Download Whitepaper',
  'index.menu.whitepaper.content':'https://s3.ap-northeast-2.amazonaws.com/astera/ASTERA.com/ASTERA_v0.1_EN.pdf',
  'index.button.language': `언어: 한국어`,

  'index.preorder.heading': `Worldwide Shipping`,
  'index.preorder.description': `Ships June 2018`,
