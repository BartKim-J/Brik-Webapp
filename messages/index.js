...
Spendwallet is seductively designed to completely replace your existing wallet. The backside pocket is for your ID, cash, or anything that cannot be stored digitally on the device.`,
  ...
  'presskit.message.title': `Press Release (TCDNY 2017)`,
  'presskit.message.date': `Last updated on May 08, 2017`,
  'presskit.message': `
    <p><b>*X Lab unveils two new products that implement their innovative magnetic payment solution at TCDNY 2017*</b></p>
    ...
    <p>After confirming a growing market demand of its payment solution, X Lab carefully calibrated next Spend model and found TCDNY 2017 to be right place to bring their payment solution to life in two form factors - wearable and card. Spend Wearable may be already expected from X Lab, but Spend in card format was spotlighted for its compatibility of being put in original wallet or mobile phone case. It should be well noted that its solution with customized RF antenna can be integrated into as small as fitness tracker and as thin as card size.</p>
    ...
    <strong>Visit X Lab at TCDNY 2017</strong>
    <p>Attendees and media are invited to experience a demonstration of smart, secure payment with Spend lineup at TCDNY Startup Alley on May 16th.</p>
