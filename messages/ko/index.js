...
module.exports = messages.merge({
  ...
  모든 것을 디지털화 할 필요는 없습니다. 여러분의 신분증과 교통카드는 스펜드월렛 뒷면 포켓에 담으세요.`,
    ...
    'index.heading.fat': `매일 매일 변화하는<br /> 건강데이터를 손쉽게 확인 해보세요.`,
    'index.heading': `ASTERA는 개인의 건강데이터를<br /> 수집하고 분석할 수 있는 블록체인입니다.<br /> 무료로 제공되는 ASTERA 기기를 통해<br /> 손쉽게 데이터를 수집하고 관리 해보세요.`,
    'index.newsletter.heading': `더 많은 정보를 받아보고 싶으세요?`,
    'index.newsletter.submit':'구독',
    'index.charge.description': `개인 건강 데이터의 블럭체인과<br /> IoMT 하드웨어 기기`,
