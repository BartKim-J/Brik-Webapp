...
module.exports = messages.merge({
  ...
  스펜드월렛은 당신을 더 멋있고 스마트하게 바꿔줄 진정한 전자지갑입니다. 보유하고 있는 모든 카드를 합칠 수 있고, 후면부에는 신분증, 명함 등을 담을 수 있는 포켓이  있습니다. 그 어떤 지갑보다 얇지만, 그 어떤 지갑보다 많은 신용카드를 수납할 수 있습니다.`,
    ...
    'index.tech.section.description': `The thinnest electronic wallet youll ever own`,
    'index.tech.heading': `진정한 전자지갑의 모습.`,
    'index.tech.description': `기존의 무겁고 두꺼웠던 지갑 대신, 스마트한 전자지갑의 시대가 열립니다.<br />스펜드월렛은 당신의 모든 카드를 통합해줄 진정한 전자지갑입니다.`,
    'index.tech.touch.title': `Capacitive Touch Sensors`,
    'index.tech.touch.description': `Easy button to select the card`,
    'index.tech.battery.title': `Simply Rechargeable`,
    'index.tech.battery.description': `Up to 4 weeks of battery life`,
    'index.tech.led.title': `Hidden LED Display`,
    'index.tech.led.description': `Shown only when in use`,
    'index.security.section.heading': `Security`,
    'index.security.section.description': `Forget about your wallet and live your present.`,
    ...
    'index.button.preorder': `Coming soon at `,
