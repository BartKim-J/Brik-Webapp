...
module.exports = Immutable({
  col1: [{
    ...
    entries: [{
      ...
      answer: `한 번 완충하면, 최대 4주까지 사용 할 수 있습니다. 배터리 지속시간은 사용방식에 따라 조금 차이가 있을 수 있습니다.`
    }, {
      question: `지원하는 모바일 운영체제는 무엇인가요?`,
      answer: `안드로이드 혹은 아이폰 사용자라면 누구나 스펜드 모바일 앱을 내려받을 수 있으며, 앱을 통해 간편하게 카드를 관리 할 수 있습니다.`
    }]
  },
  {
    title: `How to Use`,
  ...
  },
  {
    ...
    entries: [{
      ...
      answer: `스펜드월렛은 다른 올인원 스마트 카드보다 결제 성공률이 더 높습니다. 우리는 시중의 모든 올인원카드를 테스트해보았으나 기존의 스와이프 형식의 결제는 기술적으로 완벽한 결제 성공률을 보장할 수 없습니다. 따라서 스펜드월렛은 스와이프 방식이 아닌 탭투페이(Tap-to-Pay) 방식을 채택해 완벽에 가까운 결제 성공률을 자랑합니다.`
    }]
  }],
  col2: [{
    title: `Security`,
    ...
    entries: [{
      ...
      answer: `스펜드월렛은 현재 미국 크라우드펀딩 인디고고 사이트에서 판매하고 있습니다.`
    }, {
      question: `언제 제품을 받아볼 수 있나요?`,
      answer: `늦어도 2016년 8월 전에 제품을 받아보실 수 있도록 최대한 빨리 배송해드리겠습니다.`
    }, {
